...
public class VacantesController {
	...
	@Autowired
	@Qualifier("categoriasServiceImplJpa") //Esta anotacion nos permite indicar que implementacion queremos inyectar
...
//			@RequestParam("descripcion") String descripcion, @RequestParam("categoria") int categoria,
...
//	}
	...
	public String eliminar(@PathVariable("id") int idVacante, RedirectAttributes attributes) {
		...
		Vacante vacanteDel = serviceVacantes.buscarPorId(idVacante);
		String rutaFile = new StringBuilder()
				.append(this.ruta)
				.append(vacanteDel.getImagen())
				.toString();
		boolean isDeleteAFile = Utileria.eliminarArchivo(rutaFile);
		serviceVacantes.eliminar(idVacante);
		if(isDeleteAFile) {			
			attributes.addFlashAttribute("msg", "La vacante fue eliminada, junto con la imagen");
		}else {			
	...
	@ModelAttribute //Forma para agregar modelos de forma general a todos los metodos de este controlador

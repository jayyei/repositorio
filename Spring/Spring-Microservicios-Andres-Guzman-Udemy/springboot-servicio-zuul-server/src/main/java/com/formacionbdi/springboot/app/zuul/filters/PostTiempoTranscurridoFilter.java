...
//Existen filtros de Zuul, en teoria existen 4 tipos de filtros, en este caso este es el tipo post
@Component
public class PostTiempoTranscurridoFilter extends ZuulFilter{
	...
	public String filterType() {
		...
		return "post"; //Siemrpe con las palabras clave pre, post, routes
	}

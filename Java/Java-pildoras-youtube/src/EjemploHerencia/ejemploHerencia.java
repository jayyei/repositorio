...
public class ejemploHerencia {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\nImprimimosel objeto Empleado2");
        System.out.println(e2);

//Al crear un nuevo objeto de java.util.Datenos regresa la fecha actual
        Cliente c1 =new Cliente(new java.util.Date(), false);
        System.out.println("\nImprimimosel objeto Cliente1");
...
//Completamos el objeto persona asociado a este objeto cliente
        ...
        System.out.println("\nVolvemosa imprimir el objeto cliente1");
        System.out.println(c1);
    }
}

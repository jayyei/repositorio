...
/*
select * from mm_projects where dx_deleted is null;
select * from dd_project_folios;
update dd_project_folios set dx_closed=null, dx_key='WALMARTCELULAANALYTICS-111' where sk_id = 28 ; 
update dd_project_folios set dx_key = 'KEY-'||sk_id ;
delete from dd_project_folios ; 
SELECT * FROM mm_users;

select * from dd_project_folios where sk_id=42;
*/
...
alter table dd_folio_workflows add dn_remote_id integer ; 
alter table dd_folio_workflows add dx_deleted varchar(3); 
...
--drop table dd_workflow_custom_tags ;
...
select * from mm_projects where dx_deleted is null ; 
select * from dd_project_folios where dx_closed is null ;





select * from dd_folio_workflows; 
select * from mm_users ;

insert into dd_folio_workflows values ( -4, 54,  23, 'Microservicios', 20190130, 8, null,null,null,null );
insert into dd_folio_workflows values ( -1, 54,  23, 'Marco test 3', 20190129, 4.5, null,null,null,null );
insert into dd_folio_workflows values ( -11, 54,  44, 'Cesartest 3', 20190129, 8, null,null,null,null );
insert into dd_folio_workflows values ( -2, 54,  23, 'Marco test 1', 20190128, 5, null,null,null,null );
insert into dd_folio_workflows values ( -3, 54,  23, 'Marco test 2', 20190128, 3, null,null,null,null );
insert into dd_folio_workflows values ( -5, 54,  23, 'Puro front', 20190127, 8, null,null,null,null );
insert into dd_folio_workflows values ( -7, 54,  23, 'Presentacion', 20190125, 8, null,null,null,null );
insert into dd_folio_workflows values ( -8, 54,  23, 'Codigo', 20190124, 8, null,null,null,null );
insert into dd_folio_workflows values ( -6, 54,  23, 'Codigo', 20190123, 8, null,null,null,null );
insert into dd_folio_workflows values ( -9, 54,  23, 'Codigo', 20190122, 8, null,null,null,null );
insert into dd_folio_workflows values ( -10, 54, 23, 'Incio Sprint', 20190121, 8, null,null,null,null );
--delete from dd_folio_workflows where sk_id=-1 ; 
